...
export interface BackendActor {
  ...
  update_family_member: (request: UpdateFamilyMemberRequest) => Promise<FamilyMemberResult>;
  
  add_member_event: (request: AddEventRequest) => Promise<FamilyEventResult>;
  update_member_event: (request: UpdateEventRequest) => Promise<FamilyEventResult>;
