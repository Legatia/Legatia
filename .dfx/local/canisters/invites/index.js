...
import { idlFactory } from './invites.did.js';
export { idlFactory } from './invites.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.INVITES_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./invites.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the invites canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./invites.did.js")._SERVICE>}
 */
export const invites = createActor(canisterId);
