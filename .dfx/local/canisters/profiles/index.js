...
import { idlFactory } from './profiles.did.js';
export { idlFactory } from './profiles.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PROFILES_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./profiles.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the profiles canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./profiles.did.js")._SERVICE>}
 */
export const profiles = createActor(canisterId);
