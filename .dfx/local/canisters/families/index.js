...
import { idlFactory } from './families.did.js';
export { idlFactory } from './families.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FAMILIES_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./families.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the families canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./families.did.js")._SERVICE>}
 */
export const families = createActor(canisterId);
